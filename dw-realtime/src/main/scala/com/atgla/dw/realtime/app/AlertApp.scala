...
import com.atgla.dw.realtime.bean.{AlertInfo, EventInfo}
import com.atgla.dw.realtime.utils.{MyEsUtil, MyKafkaUtil}
...
object AlertApp {
  ...
  def main(args: Array[String]): Unit = {
    ...
    //      2  5分钟内 ( 为测试 暂时统计30秒)    滑动窗口  窗口大小  滑动步长
...
//
    ...
    alertInfoDstream.foreachRDD{rdd=>
      rdd.foreachPartition{ alterInfoItr=>
        ...
        MyEsUtil.insertBulk(GmallConstants.ES_INDEX_ALERT,alertList)
      }
