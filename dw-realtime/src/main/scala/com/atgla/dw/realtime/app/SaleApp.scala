...
import com.atgla.dw.realtime.bean.{OrderDetail, OrderInfo, SaleDetail, UserInfo}
...
object SaleApp {
  ...
  def main(args: Array[String]): Unit = {
    ...
    val inputOrderDstream: InputDStream[ConsumerRecord[String, String]] = MyKafkaUtil.getKafkaStream(GmallConstants.KAFKA_TOPIC_ORDER,ssc)
    ...
    //用户数据实时写入缓存中
    val inputUserInfoDstream: InputDStream[ConsumerRecord[String, String]] = MyKafkaUtil.getKafkaStream(GmallConstants.KAFKA_TOPIC_USER,ssc)
